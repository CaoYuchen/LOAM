...
namespace velodyne_rawdata
{
  ...
  static const std::uint16_t ROTATION_MAX_UNITS = 36000; /**< hundredths of degrees */
  ...
  static const std::uint16_t UPPER_BANK = 0xeeff;
  static const std::uint16_t LOWER_BANK = 0xddff;
  ...
  {
    std::uint16_t header;        ///< UPPER_BANK or LOWER_BANK
    std::uint16_t rotation;      ///< 0-35999, divide by 100 to get degrees
