...
rosnode kill velodyneCloudReceiver stack_gps driver_nodelet velodyne_nodelet_manager cloud_nodelet ueye_cam_nodelet nodelet_manager check_ueye_api receive_xsens watchdog_all
sleep 2
